//solves problem 6 from section 5.9
#include <iostream>
#include <functional>
#include <vector>
#include <cmath>
...
int main()
{
  ...
  auto x1dot =  [&](double t, double x1, double x2){
    return x1*(4 - 0.0003*x1 - 0.0004*x2);
  };

  //derivative of x2 with respect to t
  auto x2dot =  [&](double t, double x1, double x2){
    return x2*(2 - 0.0002*x1 - 0.0001*x2);
  };


  double initial_x1 = 10000;
  double initial_x2 = 10000;

  double h = 0.1;
  double a = 0;
  double b = 4;
  auto approximation = rungeKutta(x1dot, x2dot, a, b, h, initial_x1, initial_x2);
